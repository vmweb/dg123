...
<form 	id="EditCustomer<?php echo $this->customer['idNumber']; ?>" 
		name="EditCustomer<?php echo $this->customer['idNumber']; ?>" 
		enctype="application/x-www-form-urlencoded" 
		method="post" 
		action="<?php echo $this->url(array('controller'=>'customer', 'action'=>'customerdetail')); ?>">
