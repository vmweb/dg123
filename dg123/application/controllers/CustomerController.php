	...
	public function customerdetailAction() {
		...
		try {
			...
			if ($this->getRequest()->isPost()) {				
		        ...
		        $formCustomerEdit->setAttrib("onSubmit", "alert('adskjhadfs');dijit.byId('customersList'.$customerItem[0]['idNumber']).href('http://localhost/vmweb2009R1/public/customer/customerdetail');");
